...
Supporting files for the interoperability test program (see [PLAN.md](../../PLAN.md), section 11).
...
handles automatically (PLAN.md §11.2): private keys are copied off `/mnt/c` into the WSL home and
...
matrix strategy (per-commit smoke vs. nightly matrix) lives in PLAN.md §11.6.
