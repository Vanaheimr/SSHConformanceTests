...
namespace org.GraphDefined.Vanaheimr.Hermod.SSH.Tests
{
    ...
    public class OpenSshTransportInteropTests
    {
        ...
        // A host key of the requested algorithm. The library's own matrix tests have an identical helper,
        // but they live in the Hermod submodule and this project cannot — and should not — reach into it.
        private static ISshHostKey MakeHostKey(String Algorithm)
            => Algorithm switch {
                                                                             ...
                                                                             CancellationToken  CancellationToken)
        {
            ...
            var hostKey = MakeHostKey(SshHostKeyAlg);
        ...
        public async Task OurServer_SendsExtInfo_RealOpenSshClientReceivesServerSigAlgs(CancellationToken CancellationToken)
        {
            ...
            var hostKey = MakeHostKey("ssh-ed25519");
